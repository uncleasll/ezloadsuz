...
def upgrade() -> None:
    ...
    stop_type.create(op.get_bind(), checkfirst=True)
...
def downgrade() -> None:
    ...
    for enum_name in ['loadstatus','billingstatus','stoptype','servicetype','documenttype','settlementstatus']:
    ...
    driver_doc_type.create(op.get_bind(), checkfirst=True)
