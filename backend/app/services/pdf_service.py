...
def generate_invoice_pdf(load: Load) -> bytes:
    buf = io.BytesIO()
    ...
    from_text = (
        ...
        "<b>Silkroad llc</b><br/>"
        ",<br/>"
        "Email: asilbekkarimov066@gmail.com<br/>"
        "Phone: (970) 610-8065"
    )
    to_text = (
        "To:<br/>"
    ...
    logo_cell = Table(
        [[P("<b>TOPTRUCK</b>", bold), P("<font size='7'>COMPANY</font>", small)]],
...
def generate_settlement_pdf(settlement) -> bytes:
    ...
    right_block = [
        P("Silkroad llc", head_r),
        P("Email: asilbekkarimov066@gmail.com", sub_r),
        P("Phone: (970) 610-8065", sub_r),
    ]
